    ...
    >
      <Slider className="w-full" {...settings}>
        <div>
          ...
          <h1 data-aos="zoom-in" data-aos-delay="50" className="text-yellow-500 border rounded-lg border-yellow-500 px-6 py-2 text-xl">Get upto Discount 80% Off</h1>
          ...
          <h1  data-aos="zoom-in" data-aos-delay="100" className="text-white text-2xl">100% trusted<span className="text-yellow-500 font-semibold"> Electronics Gadgets</span></h1>
          <button data-aos="zoom-in" data-aos-delay="200"  className="bg-amber-300 rounded-lg px-4 py-2 text-black font-semibold">ONLINE COLLECTION</button>
          </div>
        </div>
           <div>
